			    	$(".datepicker").datepicker({
			         ...
			         function addEmployee() {
						...
						var myform = topWin.document.getElementById("E_form");
						var id = topWin.document.getElementById("E_id").value;
						var gender = topWin.document.getElementById("E_gender").value;
						var name = topWin.document.getElementById("E_name").value;
						var birthdate = topWin.document.getElementById("E_birthday").value;
						var identification = topWin.document.getElementById("E_Uid").value;
						var email = topWin.document.getElementById("E_email").value;
						var department = topWin.document.getElementById("E_department").value;
						var jobtype = topWin.document.getElementById("E_jobType").value;
						var maxeducationdate = topWin.document.getElementById("E_maxEducationDate").value;
						var maxdegreedate = topWin.document.getElementById("E_maxDegreeDate").value;
						var type = topWin.document.getElementById("E_type").value;
						var source = topWin.document.getElementById("E_source").value;
						var reachschooldate = topWin.document.getElementById("E_reachSchoolDate").value;
						
						
						
					    if(null == id || "" == id ){
					        alert("职工号不能为空");
					        topWin.document.getElementById("E_id").focus();
					        return false;
					    }else if(id.length != 6){
					    	alert("职工号长度必须为6位");
					        topWin.document.getElementById("E_id").focus();
					    	...
					    	alert("姓名不能为空");
					        topWin.document.getElementById("E_name").focus();
					        return false;
					    }else if(null == birthdate || "" == birthdate ){
					    	alert("出生日期不能为空");
					        topWin.document.getElementById("E_birthday").focus();
					        return false;
					    }else if(null == identification || "" == identification ){
					    	alert("身份证号不能为空");
					        topWin.document.getElementById("E_uid").focus();
					        return false;
					    }else if(null == email || "" == email){
					    	alert("邮箱不能为空");				
					        topWin.document.getElementById("E_email").focus();
					        return false;
					    }else if(null == department || "" == department){
					    	alert("单位不能为空");				
					        topWin.document.getElementById("E_department").focus();
					        return false;					    	
					    }else if(null == jobtype || "" == jobtype){
					    	alert("岗位性质不能为空");				
					        topWin.document.getElementById("E_jobType").focus();
					        return false;
					    }else if(null ==  maxeducationdate || "" == maxeducationdate){
					    	alert("最高学历获得时间不能为空");				
					        topWin.document.getElementById("E_maxEducationDate").focus();
					        return false;
					    }else if(null ==  maxdegreedate || "" == maxdegreedate){
					    	alert("最高学位获得时间不能为空");				
					        topWin.document.getElementById("E_maxDegreeDate").focus();
					        return false;
					    }else if(null == type || "" == type){
					    	alert("人员身份不能为空");				
					        topWin.document.getElementById("E_type").focus();
					        return false;
					    }else if(null == source || "" == source){
					    	alert("入校来源不能为空");				
					        topWin.document.getElementById("E_source").focus();
					        return false;
					    }else if(null == reachschooldate || "" == reachschooldate){
					    	alert("入校报到时间不能为空");				
					        topWin.document.getElementById("E_reachSchoolDate").focus();
					        return false;
					    }
