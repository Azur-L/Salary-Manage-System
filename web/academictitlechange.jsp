		...
		<form class="form-horizontal" id="changeInfo">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<s:textfield id="workerid" name="workerid" value="%{#session.queryEmployee.id}"/>
				...
				<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input id="currenttitle" type="text" name="newLevelName"/>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input id="currentlabel" type="text" name="newLevelRank"/>
						</div>
					</div>
